...
<link href="http://www.indusrec.ca/master.css" rel="stylesheet" type="text/css">
<style type="text/css">
<!--
.style4 {color: #003E7E}
.style6 {
...
<table border="3" bordercolor="#6699CC">
        <tr><td>
                <table><tr><span class="style6">Indus Client Login</span></tr></table>
        <form action="../PublicLoginManager" method="POST">
