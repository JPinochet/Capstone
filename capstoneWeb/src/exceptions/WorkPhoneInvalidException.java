 ...
 *
 */
public class WorkPhoneInvalidException extends Exception {
	private static final long serialVersionUID = -1126353131106361549L;

	/**
	 * Initializes Exception
	 */
	public WorkPhoneInvalidException()
	{
	 ...
	 */
	public WorkPhoneInvalidException(String message)
	{
		super(message);
	}
	 ...
	 */
	public WorkPhoneInvalidException(Throwable cause)
	{
		super(cause);
	}
	 ...
	 * @param cause is the cause for the reason an exception is thrown
	 */
	public WorkPhoneInvalidException(String message, Throwable cause)
	{
		super(message, cause);
	}
