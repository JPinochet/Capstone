...
public final class EmployeeWindow_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	if(request.getParameter("error") != null && request.getParameter("error").equals("main")) {
      ...
      out.write("\t\t<title>Indus Recreational Facility | Employee Management</title>\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\t      \t$(\"#searchAC\").autocomplete(\"EmployeeManager\");\r\n");
      out.write("\t\t    });\r\n");
      out.write("\t  \t</script>\t\t\r\n");
      out.write("\t  \t\r\n");
      out.write("\t  \t");
 ...
 if(request.getParameter("error") != null && request.getParameter("error").equals("info")) { 
      ...
      out.write("\t  \t<script type=\"text/javascript\">\r\n");
      out.write("\t\t\tjQuery(document).ready(function($) {\r\n");
      out.write("\t\t\t\tjQuery.facebox({ ajax: 'EmployeeInfo.jsp?error=true'});\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t</script>\r\n");
      out.write("\t\t");
 } 
      ...
      out.write("\t\t\t\t<li><a class=\"sel\" href=\"EmployeeWindow.jsp\"><span></span>Employees</a></li>\r\n");
      ...
      out.write("\t\t\t\t\t<form action=\"EmployeeManager?do=search\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t\tSearch Employees: <br />\r\n");
      ...
      out.print( employees.size() );
      out.write("</span>\r\n");
      out.write("\t\t\t\t\t<span style=\"float:right\"><a href=\"EmployeeInfo.jsp\" rel=\"facebox\">New Employee</a></span><br />\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t<tr onclick=\"jQuery.facebox({ ajax: 'EmployeeInfo.jsp?employee=");
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print( employees.get(i).getGivenName() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print( employees.get(i).getSurname() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print( employees.get(i).getEmployeeLevel() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t&nbsp;<u>Employee Roles: </u><br />\r\n");
      out.write("\t\t\t\t<ul>\r\n");
      out.write("\t\t\t\t\t<li>1: Regular Employee</li>\r\n");
      out.write("\t\t\t\t\t<li>2: Accounting</li>\r\n");
      out.write("\t\t\t\t\t<li>3: Facility Manager</li>\r\n");
      out.write("\t\t\t\t</ul>\r\n");
