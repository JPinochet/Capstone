...
public final class AccountingWindow_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	if(request.getParameter("client") != null) {
      ...
      out.write("\t\t\t\t<li><a href=\"ScheduleWindow.jsp\"><span></span>Schedule</a></li>\r\n");
      out.write("\t\t\t\t<li><a class=\"sel\" href=\"AccountingWindow.jsp\"><span></span>Accounting</a></li>\r\n");
      ...
      out.print( i.getId() );
      out.write("' });\">");
      out.print( i.getPaid()?"Paid":"Due On:" + new SimpleDateFormat("MM/dd/yyyy").format(i.getDueDate()) );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td onclick=\"alert('Email')\"><img src=\"img/icons/email_go.png\" alt=\"Email\" title=\"Email\" border=\"0\" /></td>\r\n");
      out.write("\t\t\t\t\t\t<td onclick=\"alert('Print')\"><img src=\"img/icons/printer.png\" alt=\"Print\" title=\"Print\" border=\"0\" /></td>\r\n");
      out.write("\t\t\t\t\t\t<td onclick=\"alert('Excel')\"><img src=\"img/icons/page_excel.png\" alt=\"Excel\" title=\"Excel\" border=\"0\" /></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t<tr onclick=\"location='AccountingWindow.jsp?client=");
      out.print(c.getId() );
      out.write("'\"><td>");
      out.print( c.getGivenName() + " " + c.getSurname() );
      out.write("</td></tr>\r\n");
