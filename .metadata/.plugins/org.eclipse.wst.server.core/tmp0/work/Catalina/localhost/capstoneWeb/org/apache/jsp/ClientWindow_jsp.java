...
public final class ClientWindow_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	if(request.getParameter("error") != null && request.getParameter("error").equals("main")) {
      ...
      out.write("\t\t<title>Indus Recreational Facility | Client Management</title>\r\n");
      out.write("\t\t\r\n");
 ...
 if(request.getParameter("error") != null && request.getParameter("error").equals("info")) { 
      ...
      out.write("\t  \t<script type=\"text/javascript\">\r\n");
      out.write("\t\t\tjQuery(document).ready(function($) {\r\n");
      out.write("\t\t\t\tjQuery.facebox({ ajax: 'ClientInfo.jsp?error=true'});\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t</script>\r\n");
      out.write("\t\t");
 } 
      ...
      out.write("\t\t\t\t<li><a class=\"sel\" href=\"ClientWindow.jsp\"><span></span>Clients</a></li>\r\n");
      ...
      out.write("\t\t\t\t\t<form action=\"ClientManager?do=search\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t\tSearch Clients: <br />\r\n");
      ...
      out.print( clients.size() );
      out.write("</span>\r\n");
      out.write("\t\t\t\t\t<span style=\"float:right\"><a href=\"ClientInfo.jsp\" rel=\"facebox\">New Client</a></span><br />\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t    \r\n");
      out.write("\t\t\t\t\t<tr onclick=\"jQuery.facebox({ ajax: 'ClientInfo.jsp?client=");
      out.print( clients.get(i).getId() );
      out.write("' });\">\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print( clients.get(i).getGivenName() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print( clients.get(i).getSurname() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print( clients.get(i).getEmail() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print( clients.get(i).getHomePhone() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print( clients.get(i).getWorkPhone() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print( clients.get(i).getCellPhone() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t");
