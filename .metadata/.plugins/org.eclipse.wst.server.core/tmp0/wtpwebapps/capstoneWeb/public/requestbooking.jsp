...
<body bgcolor="#FFFFFF">
<table style=width:45% border="3" bordercolor="#6699CC">
        <tr><td><font color="#5191CD"> <h1>Booking Request Form</h1></font></td><td align="center"><a href="clientinvoice.jsp">Back</a></td><td align="center"><a href="login.jsp?logout=true">Logout</a></td></tr></table>
 <table style=width:45% border="3" bordercolor="#6699CC" ><tr><td>
 <form name="emailForm" method="post" action="mailto:kmoloughlin@gmail.com?subject=Request Booking" enctype="application/x-www-form-urlencoded">
	...
	<table align="center" style="width:50%; border="2" bordercolor="#6699CC">
	<tr><td style="padding-right:5px">Name:</td>
	 <td>
	   <input type="text" name="givename" value="<%= fullname %>"/>
	 </td>
	</tr>
	<tr><td style="padding-right:5px">Email:</td>
	 <td><input type="text" name="email" value="<%= (String)session.getAttribute("email") %>"/>
	 </td>
	</tr>
    <tr><td style="padding-right:5px">Event Date:</td>
     <td><input name="eventDate" type="text" id="datepicker" />
     </td>
     </tr>
    <tr><td style="padding-right:5px">Start Time:</td>
      <td><input type="text" name="starttime" />
      </td>
     </tr>
    <tr><td style="padding-right:5px">End Time:</td>
     <td><input type="text" name="endtime" />
     </td>
    </tr>
    <tr><td align="right" colspan="3"><input type="button" value="Submit" onClick="sendEmail();"></input><input type="reset" value="Clear"></input></td></tr>
	</table>
 </form></td></tr></table>
