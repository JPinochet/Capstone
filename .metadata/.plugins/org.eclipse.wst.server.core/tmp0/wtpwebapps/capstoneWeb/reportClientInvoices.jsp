...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd"><%
	...
	ArrayList<Invoice> invoice = (ArrayList<Invoice>)im.getInvoicesForClient(Integer.parseInt(request.getParameter("client")));
	im.close();
%>
...
<html>
    <head>
        ...
        <title>All invoices for <%= invoice.get(0).getClient().getGivenName() + " " + invoice.get(0).getClient().getSurname() %></title>
